...
def st_coordDim(col: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_coordDim)(col)
...
def st_dimension(col: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_dimension)(col)

def st_envelope(col: ColumnOrName) -> Column:
    """Returns a Geometry representing the bounding box of geom."""
    return build_scala_udf(spark_context, geomesa_functions.st_envelope)(col)
...
def st_exteriorRing(col: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_exteriorRing)(col)
...
def st_geometryN(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_geometryN)(col1, col2)

def st_geometryType(col: ColumnOrName) -> Column:
    """Returns the type of this Geometry."""
    return build_scala_udf(spark_context, geomesa_functions.st_geometryType)(col)
...
def st_interiorRingN(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_interiorRingN)(col1, col2)
...
def st_isClosed(col: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_isClosed)(col)

def st_isCollection(col: ColumnOrName) -> Column:
    """Returns true if geom is a GeometryCollection."""
    return build_scala_udf(spark_context, geomesa_functions.st_isCollection)(col)

def st_isEmpty(col: ColumnOrName) -> Column:
    """Returns true if geom is empty."""
    return build_scala_udf(spark_context, geomesa_functions.st_isEmpty)(col)
...
def st_isRing(col: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_isRing)(col)
...
def st_isSimple(col: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_isSimple)(col)
...
def st_isValid(col: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_isValid)(col)
...
def st_numGeometries(col: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_numGeometries)(col)

def st_numPoints(col: ColumnOrName) -> Column:
    """Returns the number of vertices in Geometry geom."""
    return build_scala_udf(spark_context, geomesa_functions.st_numPoints)(col)
...
def st_pointN(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_pointN)(col1, col2)

def st_x(col: ColumnOrName) -> Column:
    """If geom is a Point, return the X coordinate of that point."""
    return build_scala_udf(spark_context, geomesa_functions.st_x)(col)

def st_y(col: ColumnOrName) -> Column:
    """If geom is a Point, return the Y coordinate of that point."""
    return build_scala_udf(spark_context, geomesa_functions.st_y)(col)

# Geometric Cast Functions

def st_castToPoint(col: ColumnOrName) -> Column:
    """Casts Geometry g to a Point."""
    return build_scala_udf(spark_context, geomesa_functions.st_castToPoint)(col)

def st_castToPolygon(col: ColumnOrName) -> Column:
    """Casts Geometry g to a Polygon."""
    return build_scala_udf(spark_context, geomesa_functions.st_castToPolygon)(col)

def st_castToLineString(col: ColumnOrName) -> Column:
    """Casts Geometry g to a LineString."""
    return build_scala_udf(spark_context, geomesa_functions.st_castToLineString)(col)
...
def st_castToGeometry(col: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_castToGeometry)(col)

def st_byteArray(col: ColumnOrName) -> Column:
    """Encodes string s into an array of bytes using the UTF-8 charset."""
    return build_scala_udf(spark_context, geomesa_functions.st_byteArray)(col)
...
def st_geomFromGeoHash(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_geomFromGeoHash)(col1, col2)

def st_box2DFromGeoHash(col: ColumnOrName) -> Column:
    """Alias of st_geomFromGeoHash."""
    return build_scala_udf(spark_context, geomesa_functions.st_box2DFromGeoHash)(col)

def st_geomFromText(col: ColumnOrName) -> Column:
    """Alias of st_geomFromWKT."""
    return build_scala_udf(spark_context, geomesa_functions.st_geomFromText)(col)

def st_geometryFromText(col: ColumnOrName) -> Column:
    """Alias of st_geomFromWKT"""
    return build_scala_udf(spark_context, geomesa_functions.st_geometryFromText)(col)

def st_geomFromWKT(col: ColumnOrName) -> Column:
    """Creates a Geometry from the given Well-Known Text representation (WKT)."""
    return build_scala_udf(spark_context, geomesa_functions.st_geomFromWKT)(col)

def st_geomFromWKB(col: ColumnOrName) -> Column:
    """Creates a Geometry from the given Well-Known Binary representation (WKB)."""
    return build_scala_udf(spark_context, geomesa_functions.st_geomFromWKB)(col)

def st_lineFromText(col: ColumnOrName) -> Column:
    """Creates a LineString from the given WKT representation."""
    return build_scala_udf(spark_context, geomesa_functions.st_lineFromText)(col)
...
def st_makeBox2D(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_makeBox2D)(col1, col2)
...
def st_point(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_point)(col1, col2)
...
def st_asLatLonText(col: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_asLatLonText)(col)

def st_asText(col: ColumnOrName) -> Column:
    """Returns Geometry geom in WKT representation."""
    return build_scala_udf(spark_context, geomesa_functions.st_asText)(col)
...
def st_geoHash(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_geoHash)(col1, col2)
...
def st_antimeridianSafeGeom(col: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_antimeridianSafeGeom)(col)
...
def st_bufferPoint(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_bufferPoint)(col1, col2)
...
def st_translate(col1: ColumnOrName, col2: ColumnOrName, col3: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_translate)(col1, col2, col3)

def st_contains(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    """Returns true if and only if no points of b lie in the exterior of a, and at least one point of the interior of b lies in the interior of a."""
    return build_scala_udf(spark_context, geomesa_functions.st_contains)(col1, col2)

def st_covers(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    """Returns true if no point in Geometry b is outside Geometry a."""
    return build_scala_udf(spark_context, geomesa_functions.st_covers)(col1, col2)

def st_crosses(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    """Returns true if the supplied geometries have some, but not all, interior points in common."""
    return build_scala_udf(spark_context, geomesa_functions.st_crosses)(col1, col2)
...
def st_disjoint(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_disjoint)(col1, col2)
...
def st_equals(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_equals)(col1, col2)
...
def st_intersects(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_intersects)(col1, col2)
...
def st_overlaps(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_overlaps)(col1, col2)

def st_touches(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    """Returns true if the geometries have at least one point in common, but their interiors do not intersect."""
    return build_scala_udf(spark_context, geomesa_functions.st_touches)(col1, col2)

def st_within(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    """Returns true if geometry a is completely inside geometry b."""
    return build_scala_udf(spark_context, geomesa_functions.st_within)(col1, col2)
...
def st_relate(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_relate)(col1, col2)
...
def st_relateBool(col1: ColumnOrName, col2: ColumnOrName, col3: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_relateBool)(col1, col2, col3)
...
def st_area(col: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_area)(col)

def st_centroid(col: ColumnOrName) -> Column:
    """Returns the geometric center of a geometry."""
    return build_scala_udf(spark_context, geomesa_functions.st_centroid)(col)
...
def st_closestPoint(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_closestPoint)(col1, col2)
...
def st_distance(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_distance)(col1, col2)
...
def st_distanceSphere(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_distanceSphere)(col1, col2)
...
def st_length(col: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_length)(col)
...
def st_lengthSphere(col: ColumnOrName) -> Column:
    ...
    return build_scala_udf(spark_context, geomesa_functions.st_lengthSphere)(col)
